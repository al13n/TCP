...
time_cli: time_cli.o
	${CC} ${CFLAGS} -o time_cli time_cli.o ${LIBS}
time_cli.o: time_cli.c
	${CC} ${CFLAGS} -c time_cli.c


echo_cli: echo_cli.o
	${CC} ${CFLAGS} -o echo_cli echo_cli.o ${LIBS}
...
server: tcpechotimesrv.o readline.o
	${CC} ${CFLAGS} -o server tcpechotimesrv.o readline.o ${LIBS}
tcpechotimesrv.o: tcpechotimesrv.c
	${CC} ${CFLAGS} -c tcpechotimesrv.c


client: tcpechotimecli.o echo_cli time_cli
	${CC} ${CFLAGS} -o client tcpechotimecli.o ${LIBS}
